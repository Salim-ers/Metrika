// ⚠️ Fichier généré depuis prisma/init.sql (ne pas éditer à la main).
...
// Régénération :
//   npx prisma migrate diff --from-empty --to-schema-datamodel prisma/schema.production.prisma --script > prisma/init.sql
